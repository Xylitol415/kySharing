	        ...
	        <td colspan="8" align="center" style="font-size:18px">
		    	第 ${pageBean.currentPage } / ${pageBean.totalPage }
				  	...
				  	<c:if test="${pageBean.currentPage !=1 }">
				  			<a href="NoteListPageServlet?currentPage=1">首页</a>
							|<a href="NoteListPageServlet?currentPage=${pageBean.currentPage-1 }">上一页</a>
				  		</c:if>
				  		...
				  		<c:forEach begin="1" end="${pageBean.totalPage }" var="i">
				  			...
				  			<c:if test="${pageBean.currentPage != i }">
				  				<a href="NoteListPageServlet?currentPage=${i }">${i }</a>
				  			</c:if>
				  		...
				  		<c:if test="${pageBean.currentPage !=pageBean.totalPage }">
				  			<a href="NoteListPageServlet?currentPage=${pageBean.currentPage+1 }">下一页</a> | 
				  			<a href="NoteListPageServlet?currentPage=${pageBean.totalPage }">尾页</a>
				  		</c:if>
	        </td>
	    </tr>
	    </tfoot>
